...
const comentarioSchema = new Schema({
  // Autor polimórfico: referencia según usuarioTipo
  usuario:      { type: Schema.Types.ObjectId, required: true, refPath: 'usuarioTipo' },
  usuarioTipo:  { type: String, required: true, enum: ['Cliente', 'Emprendedor', 'Administrador'] },

  // Destino (simple): Producto o Emprendimiento
...
// Índice para listar rápido por destino
